...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate >
            ...
            <br />
            <asp:Button ID="btnNuevo" runat="server" Text="Agregar Profesor" OnClick="btnNuevo_Click" />
            &nbsp;
            <br />
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="CajaDialogo" align="center" Style="display:table" Width="700">
            ...
            <table style="border: Solid 3px #D55500; height: 308px;"
                ...
                <tr>
                    <td align="right" class="labelContenido">Curso:</td>
                    <td align="left">
                        <asp:DropDownList ID="DropDownList1" runat="server" 
                            Width="250px" AutoPostBack="True" 
                            OnSelectedIndexChanged="cboCurso_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
    ...
    <asp:Panel ID="Panel2" runat="server" CssClass="CajaDialogo" align="center" Style="display:table" Width="700">
            ...
            <table style="border: Solid 3px #D55500; height: 308px;"
                ...
                <tr>
                    <td align="right" class="labelContenido" style="width: 45%">Celular: </td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" class="labelContenido">
                        Curso:</td>
                    <td align="left">
                        <asp:DropDownList ID="cboCurso" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cboCurso_SelectedIndexChanged" Width="250px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
